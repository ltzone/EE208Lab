        ...
        for line in lines:
            ...
            try:
                if (filename2[5]=='i'):
                    ...
                    filename2 = filename2[:4]+filename2[5:]



                    print "adding", filename,'\n'

                    path2="sn_cmt_tags/" + filename2
                    path3="sn_cmt_SCORE/" + filename2
                    path = "html_sn/"+ filename2
                    print path,path2,path3
                    ...
                    if (len(ll) == 7):
                        ...
                        doc.add(Field("attribute", ll[6], t3))
                        print 'add attribute', ll[6], '\n'
                        doc.add(Field("detail", '', t3))
                        print 'add detail', '', '\n'
                        doc.add(Field("tag", tag, t3))
                        print 'add tag', tag, '\n'
                        doc.add(Field("website","苏宁",t4))
                        print 'add website',"苏宁",'\n'
                        num += 1
