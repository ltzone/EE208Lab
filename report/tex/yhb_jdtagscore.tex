...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{img/yhbweb_source_code_jd.png}
\caption{京东网页源码中查询评价的结果} %图片下方文字标签
\label{img:yhb_pict1}   % 引用标记，用于文章中引用
\end{figure}
...
\label{img:yhb_pict2}   % 引用标记，用于文章中引用
\end{figure}
...
\label{img:yhb_pict3}   % 引用标记，用于文章中引用
\end{figure}
...
\label{img:yhb_pict4}   % 引用标记，用于文章中引用
\end{figure}
...
\label{img:yhb_pict5}   % 引用标记，用于文章中引用
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{folder view jd.png}
\caption{文件夹中显示，已打码处理} %图片下方文字标签
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{contents eg jd.png}
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{res1 jd.png}
\caption{在文件夹中显示}
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{res2 jd.png}
\caption{内容示例}
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{error eg.png}
\caption{错误示例}
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
为什么会变成这样呢？
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{files jd.png}
\caption{在文件夹中显示}
%\label{img:zlt_pict1}   % 引用标记，用于文章中引用
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=13.5cm]{problem code.png}
\end{figure}
